/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fd7fe0264dc926465b26650fbfb802fc)
...
declare namespace Cloudflare {
	...
	interface Env {
		KV: KVNamespace;
		GoogleOAuthClientId: "361063225776-2e94e56fbquei9mmarako1nnfq9ck7qu.apps.googleusercontent.com";
		RadicaleUrl: "http://cal.sdnts.dev/sdnts/shared/";
		DEBUG: "false" | "true";
		GoogleOAuthClientSecret: string;
		AppHost: string;
		BeelinkTunnel: Fetcher;
		RefreshGoogleToken: Workflow<Parameters<import("./src/index").RefreshGoogleToken['run']>[0]['payload']>;
		RadicaleToGoogle: Workflow<Parameters<import("./src/index").RadicaleToGoogle['run']>[0]['payload']>;
		GoogleToRadicale: Workflow<Parameters<import("./src/index").GoogleToRadicale['run']>[0]['payload']>;
	}
}
