...
declare namespace Cloudflare {
	...
	interface Env {
		...
		RefreshGoogleToken: Workflow<
			Parameters<import("./src/index").RefreshGoogleToken["run"]>[0]["payload"]
		>;
		RadicaleToGoogle: Workflow<
			Parameters<import("./src/index").RadicaleToGoogle["run"]>[0]["payload"]
		>;
		GoogleToRadicale: Workflow<
			Parameters<import("./src/index").GoogleToRadicale["run"]>[0]["payload"]
		>;
	}
}
